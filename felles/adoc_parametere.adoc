...
// Kommentert ut i test :prodspekbase-url: https://sosi.geonorge.no/produktspesifikasjoner/
:prodspekbase-url: {skjemabase-url}
...
:skjema-url: {skjemabase-url}{datasett}/{skjema-versjon}
:prodspek-url: {prodspekbase-url}{datasett}
:uml-url: {umlbase-url}{datasett}/{versjon}
:reginstr-url: {reginstrbase-url}{datasett}/{skjema-versjon}
